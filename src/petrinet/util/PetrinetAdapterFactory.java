...
public class PetrinetAdapterFactory extends AdapterFactoryImpl {
	...
	protected PetrinetSwitch<Adapter> modelSwitch =
		new PetrinetSwitch<Adapter>() {
			@Override
			public Adapter caseSystem(petrinet.System object) {
			...
			@Override
			public Adapter casePetriNetRelationship(PetriNetRelationship object) {
				return createPetriNetRelationshipAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinet.System <em>System</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinet.PetriNetRelationship <em>Petri Net Relationship</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
